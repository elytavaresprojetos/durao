  ...
  <footer className="border-t border-border bg-card">
    <div className="container py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
      ...
      <p className="text-muted-foreground text-sm text-center">
        © 2026 Durão Despachante. Todos os direitos reservados.
      </p>
      ...
      <div className="flex gap-3">
        <a
          ...
          className="w-10 h-10 rounded-xl bg-soft border border-border flex items-center justify-center text-muted-foreground hover:text-primary hover:-translate-y-0.5 transition-all"
        >
        ...
        <a
          ...
          rel="noopener noreferrer"
          aria-label="WhatsApp"
          className="w-10 h-10 rounded-xl bg-soft border border-border flex items-center justify-center text-muted-foreground hover:text-success hover:-translate-y-0.5 transition-all"
        >
