const WhatsAppFloat = () => (
  <a
    ...
    aria-label="WhatsApp"
    className="fixed right-5 bottom-5 z-50 w-14 h-14 rounded-full bg-success flex items-center justify-center shadow-lg hover:-translate-y-0.5 transition-transform"
  >
